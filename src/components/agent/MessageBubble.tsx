  ...
  return (
    ...
    >
      ...
      >
        ...
        {isUser && (
          <div 
            className="readlite-message-content text-[var(--readlite-text)]/85 text-sm font-[system-ui,-apple-system,BlinkMacSystemFont,'Segoe_UI','PingFang_SC','Hiragino_Sans_GB','Microsoft_YaHei',sans-serif]" 
            style={{ 
              ...getMessageStyle(),
              fontFeatureSettings: "'tnum' on, 'lnum' on",
              textRendering: "optimizeLegibility",
